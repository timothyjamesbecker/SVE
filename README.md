...
-L or --lift_over argument is used to pass a valid chain file to the FusorSV machinery to apply crossmap lift over ( http://crossmap.sourceforge.net ), DEFAULT will use the current hg19 to HG38 lift over file taken from UCSC<br>
